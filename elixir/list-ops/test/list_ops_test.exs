defmodule ListOpsTest do
  ...
  @tag :pending
  test "native count of huge list" do
  ...
  @tag :pending
  test "native reverse of huge list" do
  ...
  @tag :pending
  test "native map of huge list" do
    assert Enum.map(Enum.to_list(1..1_000_000), &(&1 + 1)) == Enum.to_list(2..1_000_001)
  end
